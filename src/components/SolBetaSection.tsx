  ...
  return (
    <div style={{ flex: 1, paddingRight: '32px' }}>
      <div style={{
        ...
        color: '#9b8e80', fontFamily: 'Georgia, serif', marginBottom: '8px'
      }}>
        SOL vs {label}
      </div>
      <div style={{
        fontSize: '32px', fontWeight: 700,
        color: '#1a1a1a', fontVariantNumeric: 'tabular-nums',
        fontFamily: 'Georgia, serif', marginBottom: '4px', lineHeight: 1,
      }}>
        {interpretation}
      </div>
      <div style={{
        fontSize: '11px', fontWeight: 600,
        color: r.color, fontFamily: 'Georgia, serif',
        marginBottom: '6px'
      }}>
        {r.label}
      </div>
...
export default function SolBetaSection({
  solHistory,
  qqqHistory,
  yieldHistory,
  solPrice,
    ...
    <div style={{ marginBottom: '40px' }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: '10px', color: '#9b8e80', fontFamily: 'Georgia, serif' }}>
          30-day Pearson correlation · live
        </span>
      </div>
      ...
      <div style={{
        ...
        <span style={{
          marginLeft: 'auto', fontSize: '11px', color: '#9b8e80',
          fontStyle: 'italic', fontFamily: 'Georgia, serif'
        }}>
      ...
      {/* Correlation cards — no boxes, just columns */}
      <div style={{
        display: 'flex', gap: '0',
        paddingBottom: '20px',
        borderBottom: '1px solid #e8e2d6',
        ...
        <div style={{ flex: 1, borderRight: '1px solid #e8e2d6', paddingRight: '32px' }}>
          <CorrelationCard
            ...
            r={qqqInterp}
            interpretation={rQqq !== null ? rQqq.toFixed(2) : '—'}
          />
        </div>
        <div style={{ flex: 1, paddingLeft: '32px' }}>
          <CorrelationCard
            label="US 10Y Yield"
            r={yieldInterp}
            interpretation={rYield !== null ? rYield.toFixed(2) : '—'}
          />
        </div>
      </div>

      {/* Context note — no box, just indented italic */}
      <p style={{
        marginTop: '16px',
        fontSize: '12px', color: '#6b6055',
        fontStyle: 'italic', fontFamily: 'Georgia, serif',
        lineHeight: 1.7, borderLeft: '2px solid #ccc5b5',
        paddingLeft: '16px',
      }}>
