...
function getBubbleSize(event: MacroEvent): number {
  const score = IMPACT_SCORES[event.id] ?? 3
  if (event.type === 'future') return 10
  return Math.round(8 + (score - 1) * (28 / 9))
}
...
export default function TimelineSection({
  ...
  return (
    <div style={{ marginBottom: '0' }}>
      ...
      {/* Section header + legend in one row */}
      <div style={{
        borderTop: '2px solid #1a1a1a', paddingTop: '12px', marginBottom: '60px',
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          {[
            ...
            <div key={type} style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '10px', color: '#9b8e80', fontFamily: 'Georgia, serif' }}>
              <div style={{
          ...
          <span style={{ fontSize: '10px', color: '#9b8e80', fontFamily: 'Georgia, serif', fontStyle: 'italic', marginLeft: '8px' }}>
            bubble size = impact
          </span>
        </div>
      </div>
      ...
      <div style={{ padding: '8px 0 20px', position: 'relative', height: '240px' }}>
        ...
        {months.map(m => (
          <div key={m.label + m.pct} style={{
            ...
            fontSize: '10px', color: '#9b8e80', fontFamily: 'Georgia, serif', userSelect: 'none'
          }}>
            {m.label}
          </div>
        ))}
            ...
            <div key={event.id} style={{ position: 'absolute', left: `${pct}%`, top: '120px', pointerEvents: 'none' }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: isFuture
                    ? 'transparent'
                    : `radial-gradient(circle at 35% 32%, ${color}bb, ${color} 60%, ${color}ee)`,
                  border: isFuture
                    ? `1.5px dashed ${color}`
                    : isExpanded ? `2px solid #1a1a1a` : `1px solid ${color}88`,
                  boxShadow: isFuture
                    ? 'none'
                    : isExpanded
                    ? `0 0 0 3px ${color}33, inset -1px -2px 4px rgba(0,0,0,0.25), inset 1px 1px 3px rgba(255,255,255,0.35)`
                    : `inset -1px -2px 4px rgba(0,0,0,0.2), inset 1px 1px 3px rgba(255,255,255,0.35), 0 2px 8px ${color}44`,
              ...
              {/* Stem */}
              <div style={{
                position: 'absolute', left: 0, width: '1px', height: '22px',
              ...
              <div
                ...
                style={{
                  ...
                  borderRight: `1px solid ${isExpanded ? color + '44' : '#e8e2d6'}`,
                  borderBottom: `1px solid ${isExpanded ? color + '44' : '#e8e2d6'}`,
                  borderLeft: `1px solid ${isExpanded ? color + '44' : '#e8e2d6'}`,
                  padding: '6px 8px',
                  cursor: 'pointer',
              ...
              >
                ...
                <div style={{ fontSize: '9px', color: '#ccc', fontFamily: 'Georgia, serif', marginTop: '4px' }}>
          ...
          <div style={{
            ...
            {isFuture ? (
              <div>
                ...
                <div style={{ fontSize: '28px', fontWeight: 700, color, fontFamily: 'Georgia, serif' }}>
                ...
                <div style={{ fontSize: '11px', color: '#9b8e80', fontFamily: 'Georgia, serif', fontStyle: 'italic', marginTop: '4px' }}>
                  June FOMC · Warsh's first decision as Chair
                </div>
              </div>
            ) : (
              <div>
